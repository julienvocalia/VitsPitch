...
class ModularVits(BaseTTS):
    ...
    def get_optimizer(self) -> List:
        ...
        if self.training_phase==1:
            ...
            optimizer_pitch_aligner = get_optimizer(self.config.optimizer_pitch, self.config.optimizer_pitch_params, self.config.lr_pitch_aligner, parameters = pitch_align_encod_params)
            ...
            optimizer_pitch_predictor=get_optimizer(self.config.optimizer_pitch, self.config.optimizer_pitch_params, self.config.lr_pitch_predictor, parameters = pitch_pred_encod_params)
